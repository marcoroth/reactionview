...
class ReActionView::SlotsTest < Minitest::Spec
  ...
  # Client mode is what sends the client the branches a request did not take.
  test "the project default decides who renders a branch" do
    ...
    assert_includes compiled, "_herb_covered_branches"
  end
  ...
  # A marker in a text template would be output rather than structure.
