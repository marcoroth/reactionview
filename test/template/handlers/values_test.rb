...
# A request can ask for what a template's slots evaluated to rather than for its markup. The two
# compiles have to agree about everything the browser joins them by: which index is which, which
# version they were compiled at, and what a value looks like once written.
#
# The failure when they do not agree is silent. Values land in the wrong slots, or land escaped
# differently than the page would have written them, and the page just looks wrong afterwards.
